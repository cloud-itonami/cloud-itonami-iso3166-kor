# cloud-itonami-iso3166-kor

Open ISO 3166 Blueprint for **KOR**: South Korea.
...
tax registration, and local-content rules in South Korea, so the operator
...
- **Not the government of South Korea.** See
...
- **Not legal or tax advice.** Every regulatory claim must cite the
  official source and route final filings to Korea-licensed counsel
...
(ISO 3166 `KOR`). Required capabilities:
