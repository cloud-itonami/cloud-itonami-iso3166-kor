(ns marketentry.store
  "SSoT for the KOR market-entry compliance actor, behind a `Store`
...
(defn demo-data
  ...
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Kita Systems KR" :portal "KONEPS"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-kr-presence? true :has-kr-presence? true
             :requires-brn? true :brn-verified? true
             :drafted? false :submitted? false
             :jurisdiction "KOR" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "KONEPS"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-kr-presence? true :has-kr-presence? true
             :requires-brn? true :brn-verified? true
    ...
    "eng-3" {:id "eng-3" :operator "Minami Systems" :portal "KONEPS"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "KOR" :status :intake}
    "eng-4" {:id "eng-4" :operator "Higashi Export" :portal "KONEPS"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-kr-presence? true :has-kr-presence? false
             :requires-brn? true :brn-verified? true
             :drafted? false :submitted? false
             :jurisdiction "KOR" :status :intake}
    "eng-5" {:id "eng-5" :operator "Nishi Logistics" :portal "KONEPS"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-kr-presence? true :has-kr-presence? true
             :requires-brn? true :brn-verified? false
             :drafted? false :submitted? false
             :jurisdiction "KOR" :status :intake}
    "eng-6" {:id "eng-6" :operator "Chuo Civic Tech" :portal "KONEPS"
...
(defn- engagement->tx [{:keys [id operator portal base-fee monthly-rate monitoring-months claimed-fee
                               requires-kr-presence? has-kr-presence?
                               requires-brn? brn-verified?
                               drafted? submitted?
  ...
  (cond-> {:engagement/id id}
    ...
    (some? requires-kr-presence?)  (assoc :engagement/requires-kr-presence? requires-kr-presence?)
    (some? has-kr-presence?)       (assoc :engagement/has-kr-presence? has-kr-presence?)
    (some? requires-brn?)    (assoc :engagement/requires-brn? requires-brn?)
    (some? brn-verified?)    (assoc :engagement/brn-verified? brn-verified?)
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/portal :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/requires-kr-presence? :engagement/has-kr-presence?
   :engagement/requires-brn? :engagement/brn-verified?
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :portal (:engagement/portal m)
     ...
     :requires-kr-presence? (boolean (:engagement/requires-kr-presence? m))
     :has-kr-presence? (boolean (:engagement/has-kr-presence? m))
     :requires-brn? (boolean (:engagement/requires-brn? m))
     :brn-verified? (boolean (:engagement/brn-verified? m))
